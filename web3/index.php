...
function wei_to_eth_8($amount)
{
    return bcdiv(strval($amount), '100000000', 8);
}
...
$apiActions = ['version', 'create_payment', 'get_payment','transfer','get_balance','review_transaction','vendor_info','test','transfer2'];
print_r($currentUrl);
die();
