    ...
    <div class="container">
        <div class="inner__banner__content text-center">
            ...
            <ul class="breadcums d-flex flex-wrap justify-content-center">
                <p>How MLM Software Tech Works</p>
            </ul>
        </div>
    </div>
    <div class="shapes">
        ...
        <div class="row gy-5">
            <div class="col-lg-4">
                <div class="section__header m-0">
                    ...
                    <a href="contact.html" class="cmn--btn mt-4">Register</a>
                </div>
            </div>
            <div class="col-lg-8">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="section__header">
                    <h2 class="section__header-title">How MLM Software Tech Works</h2>
                ...
                <a href="contact.html" class="cmn--btn">Get Started</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="section__header mb-0">
                    ...
                    <div class="faq__wrapper">
                        ...
                        <div class="faq__item style--two open active">
                            <div class="faq__item-title">
                                <h4 class="title">What is MLM Software Tech Investment?</h4>
                            </div>
                            <div class="faq__item-content">
                                <p>The main business of MLM Software Tech investment company is to hold and manage securities for investment purposes.</p>
                            </div>
                        </div>
                        <div class="faq__item style--two">
                            <div class="faq__item-title">
                            ...
                            <div class="faq__item-content">
                                <p>MLM Software Tech invest on behalf of the investors and share the profit and losses with them in proportion to the investor's share of interest.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- <section class="download-section padding-bottom section-bg-two overflow-hidden">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="section__thumb profit__calculation__thumb rtl">
