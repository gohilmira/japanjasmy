                            ...
                            <div class="row">
                                <div class="col-lg-7 col-md-12 col-sm-12 mt-5">
                                    ...
                                    ?>
                                        <div class="form_topup">
                                            ...
                                            $orderss = $this->conn->runQuery("order_amount", 'orders', "u_code='$userid' ORDER BY id DESC LIMIT 1")[0]->order_amount;
                                            $all_pin = $this->conn->runQuery("*", 'pin_details', "status=1 and pin_rate='$orderss'");
                                            ?>
                                            ...
                                            <input type="hidden" name="selected_pin" id="selected_pin" value="Package1">
                                                <!-- <input type="hidden" name="tx_username" value="<?= $this->session->userdata('profile')->username;?>"> -->
                                                                          
                                              <div class="form-group">
                                                <label>Amount*</label>
                                                <input type="text" name="amount" id="amount" value="<?= set_value('amount');?>" class="form-control"
                                            ...
                                            if ($invest_toup_with_otp == 'yes') {
                                                ...
                                                <div id="action_areap" style="display:<?= $display; ?>">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="otp_input1" id="otp_input1"
                                                                value="<?= set_value('otp_input1'); ?>"
                                                                class="form-control user_input_text" placeholder="Enter OTP"
                                ...
                                <div class="col-sm-5 mt-5">
                                    <div class="detail_topup">
                                        ...
                                        <p><i class="fa fa-check-square" aria-hidden="true"></i> You can Upgrade any
                                            user id</p>
                                        ...
                                        <p><i class="fa fa-check-square" aria-hidden="true"></i>* Select package from
                                            the drop down menu And then click on Upgrade button.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
