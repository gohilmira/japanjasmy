...
<?php
   ...
   $cruncy=$this->conn->company_info('currency');
?>
	<?php
						...
						<div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
							<d<div class="card">
								...
								<div class="card-body">
                                    ...
                                    <input style="height:50px" type="text" id="referral_link_right" class="form-control" value="<?php echo $right_link=base_url('register?ref='.$profile->username);?>">
